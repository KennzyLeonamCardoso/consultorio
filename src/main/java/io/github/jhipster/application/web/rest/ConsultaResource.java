...
import io.github.jhipster.application.repository.ConsultaRepository;
...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Consulta}.
 */
@RestController
@RequestMapping("/api")
public class ConsultaResource {
    ...
    public ResponseEntity<Consulta> getConsulta(@PathVariable Long id) {
        ...
        Optional<Consulta> consulta = consultaRepository.findOneWithEagerRelationships(id);
