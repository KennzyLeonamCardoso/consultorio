...
describe('Service Tests', () => {
  describe('Consultorio Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(ConsultorioService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Consultorio(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Consultorio', async () => {
        const returnedFromService = Object.assign(
          {
            nome: 'BBBBBB'
          },
      ...
      it('should return a list of Consultorio', async () => {
        const returnedFromService = Object.assign(
          {
            nome: 'BBBBBB'
          },
